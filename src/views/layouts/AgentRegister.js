...
import { Container, Row, Col, Button, Input, Tooltip } from 'reactstrap';
...
import bg from '../../assets/img/agent_registration_background.jpg';
...
class AgentRegister extends Component {
  ...
  submitHandler = () => {
    ...
    if (isValid) {
      ...
      if (this.state.verified === true) {
        ...
        this.props.actionSignupUser(user,true);
      } else {
  ...
  render() { 
    ...
    return (
      <RegisterSection id="agentRegister">
        <MainMenu />
        <Container>
          <RegisterForm>
              ...
              <Row>
                ...
                <Col xs="12" sm="6">
                  <RegisterInput 
                    ...
                    onChange={e => this.inputChangeHandler(e, 'cityError')}
                  />
                  <ErrorTooltip className="danger" placement="top" isOpen={this.state.cityError !== '' ? true : false} target="city">
                ...
                <Col xs="12" sm="6">
                  <RegisterInput 
                    ...
                    onChange={e => this.inputChangeHandler(e, 'countryError')}
                  />
                  <ErrorTooltip className="danger" placement="top" isOpen={this.state.countryError !== '' ? true : false} target="country">
